...
// Page Transition - For smooth page changes
...
// Smooth Height - For expanding/collapsing content
...
// Tap Scale - For clickable elements
...
export function TapScale({ children, scale = 0.98, className }: TapScaleProps) {
  return (
    <motion.div
      whileTap={{ scale }}
